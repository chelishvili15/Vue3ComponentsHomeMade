<!-- 
    ...
    *    color="<'gray' if radioButton is dark>"
    * />
 -->
<template>
    <div class="flex -space-x-4">
        ...
        <label v-if="props.color === 'white'" :for="fieldId" class="flex space-x-2">
            <div
                class="radioButton flex items-center justify-center rounded-full"
                :class="[
        ...
        <label v-else-if="props.color === 'gray'" :for="fieldId" class="flex space-x-2">
            <div
                class="checkBox flex items-center justify-center rounded-full bg-gray-90"
                :class="[
                    focus ? 'border-1' : '',
                ]"
            >
